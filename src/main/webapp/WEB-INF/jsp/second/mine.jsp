				...
				<div class="mine_main fl">
					<div class="mine_mainHead clearfix">
						...
						<div class="mine_addr fr">
							<a href="立即购买.html">我的收货地址<span></span></a>
						</div>
					</div>
					<div class="mine_procedure">
						<ul class="clearfix">
							<li><a href="#">待付款<span>1</span></a></li>
							<li><a href="#">待发货<span>1</span></a></li>
							<li><a href="#">待收货<span id="toGet">0</span></a></li>
							<li><a href="我的2.html">待评价<span id="toEva">2</span></a></li>
							<li><a href="#">退款</a></li>
						</ul>
					</div>
